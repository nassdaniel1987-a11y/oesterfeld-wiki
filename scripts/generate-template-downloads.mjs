...
const templates = [
  {
    ...
    sections: [
      ...
      ["Anlass und Ziel", ["Beobachtung / Interesse der Kinder:", "____________________________________________________________", "Pädagogisches Ziel:", "____________________________________________________________", "Bezug zu Wiki-Seiten: Projektarbeit, Forschendes Lernen, Partizipation, Angebotsstruktur"]],
      ...
      ["Beteiligung der Kinder", ["[ ] Kinder konnten Thema oder Fragestellung mitbestimmen.", "[ ] Kinder konnten Material, Vorgehen oder Rollen mitbestimmen.", "[ ] Ergebnisse werden sichtbar gemacht."]],
      ["Reflexion", ["Was hat gut funktioniert?", "____________________________________________________________", "Wo brauchten Kinder Unterstützung?", "____________________________________________________________", "Was verändern wir beim nächsten Mal?", "____________________________________________________________"]],
    ],
  },
  {
