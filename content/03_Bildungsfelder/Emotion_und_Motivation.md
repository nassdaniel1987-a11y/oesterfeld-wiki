...
Gefühle (Emotionen) und Antriebe (Motivationen) steuern das kindliche Verhalten. Sie bedingen, wie das Kind an neue Aufgaben herangeht, und wie resilient es gegenüber Stressfaktoren ist.

## Kernthemen & Vertiefung

### Emotionsregulation & Ko-Regulation
Kinder durchlaufen eine Entwicklung von Basisemotionen (Freude, Wut, Trauer) zu sekundären, kognitiv anspruchsvolleren Emotionen (Scham, Stolz). 
Anfangs können sie Emotionen nicht selbst steuern. Fachkräfte müssen **Ko-Regulation** leisten (das Kind beruhigen, seine Signale feinfühlig spiegeln). Erst allmählich erlernt das Kind die **Selbstregulation**, indem es Worte für Gefühle findet und Strategien zur Beruhigung anwendet.
