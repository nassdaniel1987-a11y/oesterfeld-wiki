...
### Stufe 1: Initiieren
- Es gibt feste Team- und Besprechungszeiten mit klaren Zuständigkeiten.
- Ein gemeinsames pädagogisches Verständnis wird entwickelt.
- Partner im sozialen Nahraum sind bekannt und bestehende Kooperationen werden eingebunden.

### Stufe 2: Implementieren
- **Regelmäßiger Austausch:** Arbeitsbesprechungen werden gemeinsam vorbereitet; Daten über Bedürfnisse der Kinder werden systematisch genutzt.
- **Kollegiales Feedback:** Teams erproben den fachlichen Austausch (z.B. durch gegenseitige Hospitationen).
- **Arbeitsbedingungen:** Für pädagogische Mitarbeiter:innen gibt es klare Arbeitsplatzbeschreibungen und Arbeitszeitregelungen, die gemeinsam optimiert werden.
- **Gemeinsame Projekte:** Lehrkräfte und schulische Partner planen und erproben gemeinsam neue Projekte.
