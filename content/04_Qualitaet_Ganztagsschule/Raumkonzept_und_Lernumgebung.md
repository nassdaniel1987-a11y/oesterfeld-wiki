...
### Stufe 1: Initiieren
- Ausreichend Rückzugsorte für Ruhe und Entspannung sind vorhanden.
- Ein Raumbelegungsplan existiert.
- Das Außengelände kann vielfältig genutzt werden (Bewegung, Ruhe, Austausch).

### Stufe 2: Implementieren
- **Innovative Raumnutzung:** Vorhandene Klassenzimmer werden auch als Leseraum, Kreativraum oder MINT-Raum genutzt.
...
- **Differenzielle Ausstattung:** Neue Lernwelten werden eröffnet, uneingeschränkter Zugang (Inklusion) ist gewährleistet.
- **Außengelände:** Ist als direkte *Erweiterung* des schulischen Lern- und Lebensraums angelegt.
